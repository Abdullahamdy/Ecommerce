        ...
        <div class="detailsproduct">
            <div class="container">
                ...
                <div class="group">
                  ...
                  <input type="text" placeholder="معطف , مطر  ,  لباس , رياضه , حلق..." name="name" class="form-control" id="">
           ...
           {{-- <div class="group">
                  ...
                  @enderror
                    ...
                    <input type="text" class="form-control" name="status" placeholder="جديد" id="">
                    @error('status')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
                </div>
                <div class="group">
                  ...
                  <input type="text" class="form-control" name="brand" placeholder="الماركه" id="">
                  @error('brand')
                  <div class="alert alert-danger">{{ $message }}</div>
              @enderror
                </div>
              <div class="group">
                ...
                <input type="text" class="form-control" name="color" placeholder="احمر" id="">
                @error('color')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
            </div>
